...
<head>
    ...
    <title>Vca - Create a new contact</title>
        ...
        <main role="main" class="pb-3">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="../../../Contacts/Create" method="post" class="d-block m-auto w-50 mt-3">
                        ...
                        <div class="form-group">
                            ...
                            <input name="Name" class="form-control" placeholder="Name" required maxlength="50" />
                        </div>
                        <div class="form-group">
                            <label for="PhoneNumber" class="control-label"></label>
                            <input name="PhoneNumber" placeholder="Phone number" class="form-control" required maxlength="30"/>
                        </div>
